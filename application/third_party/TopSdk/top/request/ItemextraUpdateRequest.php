<?php
/**
 * TOP API: taobao.itemextra.update request
 * 
 * @author auto create
 * @since 1.0, 2014.03.04
 */
class ItemextraUpdateRequest
{
	/** 
	 * 商品上传后的状态。可选值:
...
*instock(库存中)
	...
	/** 
	 * Sku_id串 可以为空，如果为空，为新SKU 如果想要绑定已有的sku，那只有在这里传sku_id就可以 结构如：123,234
	 **/
	private $skuIds;
	...
	/** 
	 * SKU的属性串，调用taobao.itemprops.get.v2获取类目属性，如果属性是销售属性，再用taobao.itempropvalues.get取得vid。格式:pid:vid;pid:vid,… 属性有几对，那以下字段sku_quantities、sku_prices、sku_memos也需要有几对，需要一一匹配
	 **/
